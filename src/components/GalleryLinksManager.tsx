...
export function GalleryLinksManager({ links, onChange }: GalleryLinksManagerProps) {
  ...
  const handleAddLink = () => {
    ...
    setNewLink({ name: '', url: '', type: 'gdrive' });
  };
            ...
            <CardContent className="pt-4">
              <div className="flex items-start gap-3">
                <div className="flex-1 space-y-2">
                  ...
                  {link.password && (
                    <p className="text-sm text-muted-foreground">🔒 Senha: {link.password}</p>
                  )}
                  {link.instructions && (
                    <p className="text-sm text-muted-foreground">{link.instructions}</p>
                  )}
                </div>
                <Button
                  type="button"
      ...
      <div className="space-y-3 p-4 border rounded-lg bg-muted/50">
        ...
        <div className="grid gap-3">
          ...
          <div>
            ...
            <Input
              id="link-password"
              placeholder="Senha de acesso à galeria"
          ...
          <div>
            ...
            <Textarea
              ...
              placeholder="Ex: Baixe as fotos em alta resolução"
              rows={2}
