...
import { Lightbulb, User, Calendar, AlertCircle, Check, Clock, X } from "lucide-react";
...
export default function ImprovementSuggestions() {
  ...
  const { data: suggestions, isLoading } = useQuery({
    queryKey: ["all-improvement-suggestions"],
    queryFn: async () => {
  ...
  const updateStatus = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["all-improvement-suggestions"] });
